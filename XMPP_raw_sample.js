...
client.on("data", function(data) {
    ...
    if(jsonObj.hasOwnProperty('stream:stream')){
        ...
        success = true;
        client.setEncoding('utf-8');
        client.write("<stream:stream xmlns='jabber:client' to='koma-network.com' from = '6010002@koma-network.com' xmlns:stream='http://etherx.jabber.org/streams' version='1.0'>");
    }
